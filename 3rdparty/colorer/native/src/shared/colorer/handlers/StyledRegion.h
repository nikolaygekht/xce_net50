...
public:
  ...
  /** Foreground color of region rgb */
  unsigned int fore;
  /** Background color of region rgb */
  unsigned int back;
  /** Foreground color of region for console */
  unsigned int cfore;
  /** Foreground color of region for console */
  unsigned int cback;
  ...
  /** Common constructor */
  StyledRegion(unsigned int _cfore, unsigned int _cback, unsigned int _fore, unsigned int _back, unsigned int _style) {
    type = STYLED_REGION;
    bfore = bback = true;
    cfore = _cfore;
    cback = _cback;
