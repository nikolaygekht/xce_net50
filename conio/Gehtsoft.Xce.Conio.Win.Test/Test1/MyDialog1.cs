...
{
    internal class MyDialog1 : Dialog
    {
        ...
        private readonly DialogItemListBox mListBox;
        private readonly DialogItemComboBox mCb;
        ...
        public MyDialog1() : base("test", Program.CurrentSheme, false, 12, 42)
        {
            ...
            mCb = new DialogItemComboBox("", 0x1000, 9, 5, 30);
            AddItem(mCb);
